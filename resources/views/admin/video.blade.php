...
@section('title_web', 'Hyperlocal | Video')
@section('dash')
@include('partials.sidebar')
<!-- CONTENT -->
<div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
    <h1 class="uppercase font-extrabold text-xl dark:text-white">Video</h1>
    <!-- Divider -->
    <hr class="border-t border-primary-300 my-4">
    <form id="Video-form" class="mt-6" enctype="multipart/form-data">
        <div class="mb-4">
            <label for="namaVideo" class="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2">Nama Video</label>
            <input type="text" id="namaVideo" name="namaVideo" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300">
            <p class="text-red-500 text-xs italic mt-1">Wajib diisi.</p>
        </div>
        <div class="mb-4">
            <label for="VideoImage" class="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2">Gambar Video</label>
            <input type="file" id="VideoImage" name="VideoImage" accept="image/*" class="border border-gray-300 rounded-lg w-full focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300">
        </div>
        <!-- <div class="mb-4">
        ...
        <div class="mb-4">
            <label for="VideoDescription" class="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2">Deskripsi Video</label>
            <textarea id="VideoDescription" name="VideoDescription" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300" style="font-family: 'Your Font', sans-serif; font-size: 16px; line-height: 1.5;"></textarea>
        </div>
        <div class="mb-4">
    ...
    <ul class="list-disc pl-5">
        <li class="text-red-500 text-xs italic">Video bisa lebih dari satu.</li>
    ...
    <label class="block mt-4 uppercase tracking-wide text-gray-700 dark:text-gray-300 text-md font-bold mb-2">Daftar Video</label>
    <ul id="daftar-Video" class="mb-4"></ul>
</div>
