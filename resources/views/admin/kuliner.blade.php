...
@section('title_web', 'Hyperlocal | Kuliner')
@section('dash')
@include('partials.sidebar')
<!-- CONTENT -->
<div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
    <h1 class="uppercase font-extrabold text-xl dark:text-white">Kuliner</h1>
    <!-- Divider -->
    <hr class="border-t border-primary-300 my-4">
    <form id="Kuliner-form" class="mt-6" enctype="multipart/form-data">
        <div class="mb-4">
            <label for="namaKuliner" class="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2">Nama Kuliner</label>
            <input type="text" id="namaKuliner" name="namaKuliner" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300">
            <p class="text-red-500 text-xs italic mt-1">Wajib diisi.</p>
        </div>
        <div class="mb-4">
            <label for="kulinerImage" class="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2">Gambar Kuliner</label>
            <input type="file" id="kulinerImage" name="kulinerImage" accept="image/*" class="border border-gray-300 rounded-lg w-full focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300">
        </div>
        <!-- <div class="mb-4">
        ...
        <div class="mb-4">
            <label for="kulinerDescription" class="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2">Deskripsi Kuliner</label>
            <textarea id="kulinerDescription" name="kulinerDescription" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300" style="font-family: 'Your Font', sans-serif; font-size: 16px; line-height: 1.5;"></textarea>
        </div>
        <div class="mb-4">
    ...
    <ul class="list-disc pl-5">
        <li class="text-red-500 text-xs italic">Kuliner bisa lebih dari satu.</li>
    ...
    <label class="block mt-4 uppercase tracking-wide text-gray-700 dark:text-gray-300 text-md font-bold mb-2">Daftar Kuliner</label>
    <ul id="daftar-kuliner" class="mb-4"></ul>
</div>
...
<script>
    ClassicEditor
        .create(document.querySelector('#kulinerDescription'), {
