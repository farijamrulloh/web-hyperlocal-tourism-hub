            ...
            <div class="flex mt-4">
                <main class="w-2/3">
                    <article class="bg-white rounded-lg">
                        ...
                        <div id="default-carousel" class="relative w-full" data-carousel="slide">
                            ...
                            <div class="relative overflow-hidden rounded-lg mb-4 w-full h-96">
                                ...
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="hero-bg.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 h-96 object-cover object-center" alt="...">
                                </div>
                                <!-- Item 2 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="hero-bg-2.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 h-96 object-cover object-center" alt="...">
                                </div>
                                <!-- Item 3 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="hero-bg-3.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 h-96 object-cover object-center" alt="...">
                                </div>
                                <!-- Item 4 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="hero-bg-4.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 h-96 object-cover object-center" alt="...">
                                </div>
                                <!-- Item 5 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="hero-bg-5.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 h-96 object-cover object-center" alt="...">
                                </div>
                            </div>
                            <!-- Slider indicators -->
                        ...
                        <p class="text-gray-700 leading-7">
                            Ini adalah paragraf pertama dari artikel. Anda dapat menambahkan lebih banyak teks di sini
                            untuk menggambarkan konten artikel Anda. Artikel ini membahas topik yang menarik dan
                            informatif. Anda juga dapat menampilkan sebagian dari artikel Anda di sini dan menambahkan
                            tombol "Selengkapnya" untuk membaca lebih lanjut.
                        </p>
                        <p class="text-gray-700 leading-7 mt-4">
                            Ini adalah paragraf kedua dari artikel. Lanjutkan untuk menjelaskan topik Anda dan
                            berikan wawasan yang berharga kepada pembaca. Anda dapat menggunakan lebih banyak
                ...
                <aside class="ml-8 w-1/3">
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <p class="text-gray-700 mb-2"><span class="font-semibold">Alamat :</span><br>Jl. Ahmad Dahlan No.76, Mojoroto, Kec. Mojoroto, Kota Kediri, Jawa Timur 64112</p>
                        <p class="text-gray-700 mb-2"><span class="font-semibold">Telepon :</span><br>082424252253</p>
                        <p class="text-gray-700 mb-4"><span class="font-semibold">Email :</span><br>john.doe@example.com</p>
